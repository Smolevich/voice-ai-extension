...
Four 1280×800 PNGs live in `docs/screenshots/chrome-store/`. Order matters — the first is the marquee, shown on listing search results.
...
Use a separate Firefox AMO screenshot set under `docs/screenshots/amo/`:
...
The files are generated by `npm run screenshots` as 1280×800 PNGs and avoid
Chrome-specific UI.
